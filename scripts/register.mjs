...
//   node register.mjs [--base URL] register --phone <p> --vcode <c> [--type 6] [--organ ..] [--name ..] [--password ..] [--config ../config.ini]
...
const FALLBACK_REGISTER_URL = `https://platform.dknowc.cn/auth/#/register?type=${DEFAULT_TYPE}`;
